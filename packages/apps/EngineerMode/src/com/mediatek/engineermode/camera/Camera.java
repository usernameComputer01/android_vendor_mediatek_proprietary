...
public class Camera extends Activity implements OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        ...
        case ITEM_START_PREVIEW:
            Log.v("@M_" + TAG, "before start CameraPreview");
        ...
        case ITEM_HELP:
            ...
            try {
                ...
                Log.e("@M_" + TAG, "Start activity FeatureHelpPage error");
            }
            break;
        default:
            break;
    ...
    private void setPreferencesTodefault() {
        Log.v("@M_" + TAG, "Camera->setPreferencesTodefault()");
        final SharedPreferences preferences =
        ...
        case DIALOG_AF:
            ...
            builder.setSingleChoiceItems(R.array.af_mode_dialog, 0,
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        mMode = whichButton;
                        Log.i("@M_" + TAG, "Set AF Route has choice " + mMode);
                        if (mMode == 1) {
            ...
            builder.setPositiveButton(android.R.string.ok,
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        editor.commit();
                        Log.i("@M_" + TAG, "AF mode :" + mMode);
                        Log.i("@M_" + TAG, "AF step :" + mStep);
                    }
                });
            alertDlg = builder.create();
            return alertDlg;
            ...
            builder.setSingleChoiceItems(R.array.capture_mode_dialog, 0,
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        Log.i("@M_" + TAG, "Set Raw Capture Mode has choice "
                            + mRawCaptureMode);
                    }
                });
            builder.setPositiveButton(android.R.string.ok,
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        editor.commit();
                        Log.i("@M_" + TAG, "Raw Capture mode :" + mRawCaptureMode);
                    }
                });
            alertDlg = builder.create();
            return alertDlg;
            ...
            builder.setSingleChoiceItems(R.array.raw_type_dialog, 0,
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        Log.i("@M_" + TAG, "Set Raw Type has choice "
                            + mRawCaptureType);
                    }
                });
            builder.setPositiveButton(android.R.string.ok,
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        editor.commit();
                        Log.i("@M_" + TAG, "Raw Type :" + mRawCaptureType);
                    }
                });
            alertDlg = builder.create();
            return alertDlg;
            ...
            builder.setSingleChoiceItems(R.array.anti_flicker_dialog, 0,
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        Log.i("@M_" + TAG, "Set Flicker has choice " + mAntiFlicker);
                    }
                });
            builder.setPositiveButton(android.R.string.ok,
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        editor.commit();
                        Log.i("@M_" + TAG, "intent's mAntiFlicker = " + mAntiFlicker);
                    }
                });
            alertDlg = builder.create();
            return alertDlg;
            ...
            builder.setSingleChoiceItems(R.array.iso_dialog, 0,
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        Log.i("@M_" + TAG, "Set mISO has choice " + mISO);
                    }
                });
            builder.setPositiveButton(android.R.string.ok,
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        editor.commit();
                        Log.i("@M_" + TAG, "intent's mISO = " + mISO);
                    }
                });
            alertDlg = builder.create();
            return alertDlg;
